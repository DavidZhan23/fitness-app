...
- 运动、饮食及大卡记录；可选日查看与补记
- 饮食可填蛋白质、脂肪、碳水与独立跟踪的添加糖；添加糖不含完整水果、牛奶中天然糖，空项保存时可由 AI 尝试补全
- 运动 / 饮食快捷模板；饮食模板可选手填蛋白质、脂肪、碳水、添加糖，再用时按份量缩放
...
- 个人主页 + 当日热量结果文案
- 下方打卡墙：经典 / 分屏样式（设置中切换）
- 本周达成「运动大王」后解锁「小狸」陪伴舞台（可收起并记住状态；单击鼓励、双击夸奖、长按运动建议，含本地兜底）

### 营养

- 每日营养页：历史日期、宏量饼图、逐餐明细；记餐后宏量在后台估算，页顶显示「正在估算」
- 建议可切换：较高油糖 / 正常油糖 / 少油少糖；添加糖单独显示 50g 宽松上限 / 25g 推荐 / 15g 自选严格参考，少油档脂肪为 30g
- 独立微量元素页：按餐估算 16 项维生素/矿物质再汇总成三态网格；底部列出当日食物及该餐微量估算量；单项可看估算进度、人体作用、常见食物及不足建议；可打开个人参考摄入量表；记餐后后台更新且不阻塞保存
- 营养宏量/微量后台用 DeepSeek Pro；记饮食/记运动「AI 估热量」和小狸仍用 Flash
- AI 短建议仅在主动「重新评估」时调用
- 旧餐食可一次性后台补全宏量
...
- 每周一懒生成上一自然周「小满周报」：用本周运动/饮食/缺口/宏量事实、上周环比和具体小狸点评，给出至多 3 条带「为什么 / 怎么做 / 怎样算做到」的下周建议；AI 不可用时自动回退到规则文案
- 未读周报仅在今日页的「今天」视图主动提醒；设置页保留「我的周报」入口和未读红点，社区主页只展示最近一份已分享周报
