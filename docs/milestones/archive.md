# Milestones 历史（done / cancelled）

文件仍在 `docs/milestones/` 目录，仅索引归档，避免主表过长。
...
| [M-2026-05-macaron-themes](M-2026-05-macaron-themes.md) | done | `feat/style-color-tuning` |
...
| [M-2026-08-daily-nutrition-macros](M-2026-08-daily-nutrition-macros.md) | done | `dev/huanghongli`（每日营养素） |
